...
public static partial class Config {
	public static class ScriptEditor {
		...
		public static readonly float FontSize;
		...
		public static readonly float NumberToContentSpace;
		public static readonly int XCursorScreenMarginChars;
		public static readonly int YCursorScreenMarginLines;
