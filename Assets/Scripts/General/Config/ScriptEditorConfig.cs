...
public static partial class Config {
	public static class ScriptEditor {
		...
		public static readonly float	NavBarHeight		= 30;
		public static readonly float	NavBarGap			= 20;
		public static readonly float	CaretWidth			= 1.5f;
		public static readonly Color	CaretColor			= new(1, 1, 1);
		public static readonly float	MenuButtonRelWidth	= 1;
		public static readonly float	MenuNameRelWidth	= 7;
